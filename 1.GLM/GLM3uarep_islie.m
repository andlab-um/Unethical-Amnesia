...
%%
subjList = [102,103,105,106,107,108,109,110,111,112,115,116,117,118,119,120,121,123,125,127,128,129,130,131,132,133,134,135,136,137,138,139,140,141,142,143];
%subjList=[101];
...
glmdir=[topdir '1.GLM/results/GLM2uarep_SPM/'];
...
sesdata_lie=sesdata(sesdata.islie==1,:);
sesdata_hon=sesdata(sesdata.islie==0,:);
...
matlabbatch{1}.spm.stats.fmri_spec.sess(sesno).cond(1).onset = sesdata_lie.time_onset_new;
matlabbatch{1}.spm.stats.fmri_spec.sess(sesno).cond(1).duration = sesdata_lie.RT;
...
matlabbatch{1}.spm.stats.fmri_spec.sess(sesno).cond(2).onset = sesdata_hon.time_onset_new;
matlabbatch{1}.spm.stats.fmri_spec.sess(sesno).cond(2).duration = sesdata_hon.RT;
...
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'lie-hon';
